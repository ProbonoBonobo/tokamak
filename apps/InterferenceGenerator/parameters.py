from models import initialize_parameter

parameters = [
    {"name": "num_samples", "initial_value": 100, "matlab_alias": "num_samples"},
    {
        "name": "sampling_freq",
        "initial_value": 1000,
        "matlab_alias": "Fs",
    ...
    },
    {
        ...
        "matlab_type": float,
        "to_matlab": lambda parameters: parameters.n_sweeps
        * parameters.steps_per_chirp,
    },
    {
        "name": "n_hops",
        "initial_value": 0,
...
for param in parameters:
    name = param["name"]
    obj = initialize_parameter(**param)
    globals()[name] = obj
    nodes.append(obj)
